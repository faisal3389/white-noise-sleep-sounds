...
struct SoundLibrary {
    static let allSounds: [Sound] = [
        ...
        Sound(id: "brown_noise", name: "Brown Noise", category: .noise, fileName: "", backgroundImage: "bg_brown_noise", isPremium: false, isGenerated: true),
        Sound(id: "blue_noise", name: "Blue Noise", category: .noise, fileName: "", backgroundImage: "bg_blue_noise", isPremium: false, isGenerated: true),
        ...
        Sound(id: "heavy_rain", name: "Heavy Rain", category: .rain, fileName: "heavy_rain.m4a", backgroundImage: "bg_heavy_rain", isPremium: false, isGenerated: false),
        ...
        Sound(id: "birds", name: "Birds Singing", category: .nature, fileName: "birds.m4a", backgroundImage: "bg_birds", isPremium: false, isGenerated: false),
        ...
        Sound(id: "city_traffic", name: "City Traffic", category: .urban, fileName: "city_traffic.m4a", backgroundImage: "bg_city_traffic", isPremium: false, isGenerated: false),
        Sound(id: "cafe", name: "Cafe Ambience", category: .urban, fileName: "cafe.m4a", backgroundImage: "bg_cafe", isPremium: false, isGenerated: false),
        ...
        Sound(id: "ac", name: "Air Conditioner", category: .machine, fileName: "ac.m4a", backgroundImage: "bg_ac", isPremium: false, isGenerated: false),
        ...
        Sound(id: "fireplace", name: "Fireplace", category: .fire, fileName: "fireplace.m4a", backgroundImage: "bg_fireplace", isPremium: false, isGenerated: false),
